...
Обратите внимание, что размерность таблиц во всех случаях одинакова, однако, для наглядности, на большинстве графиков отображается только та часть таблицы, в которой сосредотачиваются **все** элементы. Значения коэффициентов коллизии указаны в таблице ниже.

| Название | Описание | Коэффициент коллизии |
|:----------------:|:---------:|:----------:|
| constant_hash | возвращает константу | 3743 |
| first_letter_hash | возвращает ascii-код первого символа слова | 149.72 |
| symbol_sum_hash | возвращает сумму ascii-кодов символов слова | 5.19 |
| string_len_hash | возвращает длину слова | 233.9375 |
...
![image](https://github.com/IvanBrekman/Hash_Table/blob/main/data/images/opt4_strcmp_list.png)
